...
int main() {
	...
	int socket_fs, client_socket, opt = 1, socket_length = sizeof(address), messages_count = 0;
	...
	if ((client_socket = accept(socket_fs, (struct sockaddr *)&address, (socklen_t *)&socket_length)) < 0) {
